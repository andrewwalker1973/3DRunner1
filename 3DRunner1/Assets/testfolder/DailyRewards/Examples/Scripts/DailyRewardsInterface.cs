...
namespace NiobiumStudios
{
    ...
    public class DailyRewardsInterface : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            openButton.onClick.AddListener(OnOpenButtonClick1);
        ...
        private void OnClaimPrize(int day)
        {
            ...
            //My code
            print(reward.unit);   // This is your reward Unit name
            print(reward.reward); // This is your reward count
            Debug.Log("Enable FX here ?? ");
