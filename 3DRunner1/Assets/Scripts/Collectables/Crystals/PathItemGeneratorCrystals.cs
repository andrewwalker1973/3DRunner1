...
public class PathItemGeneratorCrystals : MonoBehaviour
{
    private string containerString = "Container";
    private string straightCoinSpawnPointString = "Crystals Spawn Points"; // string to find our Spawn Points container for straight line coins
    ...
    private void SpawnCrystals()
    {
        ...
        if (Random.Range(0f, 100f) < thePlatformGenerator.crystalThreshold)
        {
            ...
            {
                thePlatformGenerator.SpawnCrystals(newPosition);
            }
        }
