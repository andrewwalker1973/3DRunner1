...
public class PathItemGeneratorStraightLineCoinSecond : MonoBehaviour
{
    private string containerString = "Container";
    private string straightCoinSpawnPointString1 = "Second Straight Coin Spawn Points"; // string to find our Spawn Points container for straight line coins
    ...
    private void SpawnStraightCoin1()
    {
        Transform spawnPoint = PickSpawnPoint(containerString, straightCoinSpawnPointString1);
