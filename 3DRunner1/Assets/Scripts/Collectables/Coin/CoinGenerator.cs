...
public class CoinGenerator : MonoBehaviour
{
   ...
   // public PoolManager thePoolManager;
    ...
    public void SpawnCoins(Vector3 startPosition)
    {
        ...
        coin5.transform.position = new Vector3(startPosition.x, startPosition.y, startPosition.z + distanceBetweenCoins + distanceBetweenCoins + distanceBetweenCoins);       // add coin to right of tart positon
