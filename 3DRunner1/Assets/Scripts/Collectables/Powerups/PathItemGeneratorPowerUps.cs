...
public class PathItemGeneratorPowerUps : MonoBehaviour
{
    private string containerString = "Container";
    private string straightCoinSpawnPointString = "PowerUp Spawn Points"; // string to find our Spawn Points container for straight line coins
    ...
    private void SpawnPowerUp()
    {
        ...
        if (Random.Range(0f, 100f) < thePlatformGenerator.powerUpThreshold)
        {
            ...
            {
                thePlatformGenerator.SpawnPowerUps(newPosition);
            }
        }
