...
public class SecondPathItemGeneratorHighLowObstacle : MonoBehaviour
{
    private string containerString = "Container";
    private string singleLaneHighLowSpawnPointString = "SecondLowHighSpawnPoints"; // string to find our Spawn Points container for straight line coins
    ...
    public void OnEnable()
    {
        ...
        SpawnSingleLaneHighLowObstacleSecond();
    ...
    private void SpawnSingleLaneHighLowObstacleSecond()
    {
