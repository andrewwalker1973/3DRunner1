...
public class ThirdPathItemGeneratorHighLowObstacle : MonoBehaviour
{
    private string containerString = "Container";
    private string singleLaneHighLowSpawnPointString = "ThirdLowHighSpawnPoints"; // string to find our Spawn Points container for straight line coins
    ...
    public void OnEnable()
    {
        ...
        SpawnSingleLaneHighLowObstacleThird();
    ...
    private void SpawnSingleLaneHighLowObstacleThird()
    {
