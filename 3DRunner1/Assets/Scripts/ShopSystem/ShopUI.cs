...
namespace ShopUpgradeSystem
{
    public class ShopUI : MonoBehaviour
    {
        ...
        public shopDataString shopData;                 //ref to ShopSaveScriptable asset
       ...
       public int currentIndex = 0;
        ...
        private void Start()
        {
            ...
            if (currentIndex == shopData.shopItems.Length - 1) next_Btn.interactable = false;
        ...
        {
            Debug.Log("nect clicked");
            Debug.Log("shopData.shopItems.Length" + shopData.shopItems.Length);
            ...
            if (currentIndex < shopData.shopItems.Length - 1)
            {
                ...
                if (currentIndex == shopData.shopItems.Length - 1)
                {
                    next_Btn.interactable = false;                           //then set nextBtn interactable false
                }
        ...
        private void PreviousButton()
        {
            if (currentIndex > 0)                           //we check is currentIndex i more than 0
            {
                ...
                if (!next_Btn.interactable)                  //if nextBtn interactable is false
                {
                    next_Btn.interactable = true;            //set nextBtn interactable to true
                }
                UnlockButtonStatus();
                UpgradeButtonStatus();
            }
