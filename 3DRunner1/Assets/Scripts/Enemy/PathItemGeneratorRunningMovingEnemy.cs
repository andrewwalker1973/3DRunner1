...
public class PathItemGeneratorRunningMovingEnemy : MonoBehaviour
{
    private string containerString = "Container";
    private string straightCoinSpawnPointString = "Running Moving Enemy Spawn Points"; // string to find our Spawn Points container for straight line coins
    ...
    private void SpawnRunningEnemy()
    {
        ...
        if (Random.Range(0f, 100f) < thePlatformGenerator.enemyThreshold)
        {
            ...
            {
                thePlatformGenerator.SpawnRunningEnemys(newPosition);
            }
        }
