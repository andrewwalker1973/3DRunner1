...
public class PathItemGeneratorLaneMovingEnemy : MonoBehaviour
{
    private string containerString = "Container";
    private string straightCoinSpawnPointString = "Lane Moving Enemy Spawn Points"; // string to find our Spawn Points container for straight line coins
    ...
    private void SpawnLaneEnemy()
    {
        ...
        if (Random.Range(0f, 100f) < thePlatformGenerator.enemyThreshold)
        {
            ...
            {
                thePlatformGenerator.SpawnLaneEnemys(newPosition);
            }
        }
